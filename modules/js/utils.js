/* Module: utils.js - Contains general utility and helper functions. */
import { autoSaveStatus, customModal, modalMessage, modalConfirmBtn, modalCancelBtn } from './ui.js';
...
export function typewriterEffect(element, text, onComplete) {
    ...
    // This function does not manage timers itself, the caller should.
}