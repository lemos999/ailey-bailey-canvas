...
export function setupGlobalEventListeners() {
    document.addEventListener('click', (e) => {
        ...
        const { setCurrentOpenContextMenu } = require('./_state.js'); // Dynamic import for setter
...
function handlePopoverAddNote() {
    ...
    const { addNote } = require('./_notesManager.js');
...
async function startQuiz() {
    ...
    try {
        ...
        const { setCurrentQuizData } = require('./_state.js');
