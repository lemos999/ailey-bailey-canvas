/* --- Module: Generic UI Utilities --- */
import * as dom from 'https://lemos999.github.io/ailey-bailey-canvas/modules/dom.js';
import { getCanvasId, getCurrentOpenContextMenu, setCurrentOpenContextMenu, getActiveTimers } from 'https://lemos999.github.io/ailey-bailey-canvas/modules/state.js';
import { auth, currentUser } from 'https://lemos999.github.io/ailey-bailey-canvas/modules/firebase.js'; // currentUser를 가져옵니다.
...
export function makePanelDraggable(panelElement) {
    ...
    header.addEventListener('mousedown', e => {
        // 이벤트 타겟이 버튼, 입력 필드 등 상호작용 요소일 경우 드래그 방지
