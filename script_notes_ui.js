 ...
 */
export function createNoteItem(noteData) {
 ...
 */
export function showContextMenu(target, event) {
 ...
 */
export function createNoteContextMenu(noteId) {
 ...
 */
export function createProjectContextMenu(projectId) {
