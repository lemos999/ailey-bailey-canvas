/*
--- Ailey & Bailey Canvas ---
File: js/utils/domElements.js
Version: 11.0 (Modular)
Description: Centralized DOM element selections. Exports all element constants for use in other modules.
*/
...
export const chatForm = document.getElementById('chat-input-form'); // Corrected from original script's chat-form
...
export const fileImporter = document.getElementById('file-importer'); // Assume this exists in the HTML, even if not used in script
export const systemResetBtn = document.getElementById('system-reset-btn');

// Dynamically created elements need to be selected after creation.
// This object will hold them once they are available.
