// Migrated content for js/ui/dom.js
...
export const clockElement = document.getElementById('real-time-clock');

export const canvasIdDisplay = document.getElementById('canvas-id-display');

export const copyBtn = document.getElementById('copy-canvas-id');

export const scrollNav = document.getElementById('scroll-nav');