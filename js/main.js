...
import { loadInitialState, getState } from './core/state.js';
...
async function initialize() {
    ...
    if (DOM.themeToggle) {
        ...
        if (localStorage.getItem('theme') !== 'light') DOM.body.classList.add('dark-mode');
        else DOM.body.classList.remove('dark-mode');
    }
    if (DOM.tocToggleBtn) {
