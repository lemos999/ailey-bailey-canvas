...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function attachEventListeners() {
        ...
        // --- Notes App Listeners (Re-architected) ---
        if (noteListView) {
        ...
        if (notesList) {
            ...
            notesList.addEventListener('dragstart', e => { /* ... unchanged ... */ });
            notesList.addEventListener('dragend', e => { /* ... unchanged ... */ });
            notesList.addEventListener('dragover', e => { /* ... unchanged ... */ });
            notesList.addEventListener('dragleave', e => { /* ... unchanged ... */ });
            notesList.addEventListener('drop', e => { /* ... unchanged ... */ });
        }
