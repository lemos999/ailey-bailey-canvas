...
File: main.js
Version: 10.0 (Split)
Description: The main entry point of the application. Initializes all modules and sets up global event listeners.
*/
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // API Settings elements are created dynamically, so we get them after creation.
    let apiSettingsBtn, apiSettingsModalOverlay, verifyApiKeyBtn,
        resetTokenUsageBtn, apiSettingsSaveBtn, apiSettingsCancelBtn;
    ...
    function initialize() {
        ...
        const handleNoteInput = () => {
            ...
            updateStatus(autoSaveStatus, '입력 중...', true);
...
🔗 연관 학습: [${title}]`;
        ...
        // Session List (Sidebar) Event Delegation
        if (sessionListContainer) {
            ...
            sessionListContainer.addEventListener('dragleave', (e) => {
                if (e.target === sessionListContainer) { sessionListContainer.classList.remove('drag-target-area'); }
            });
