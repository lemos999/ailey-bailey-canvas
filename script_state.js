...
const searchInput = document.getElementById('search-input'); // This will be removed from static, created dynamically
const addNewNoteBtn = document.getElementById('add-new-note-btn'); // This will be removed from static, created dynamically
...
let currentNoteSort = 'updatedAt_desc'; // NEW: Default sort order
let draggedNoteId = null; // [NEW] For drag & drop state tracking
...
let noteGraphData = { nodes: [], edges: [] }; // NEW: For note graph visualization
