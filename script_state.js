...
// -- [MODIFIED] Notes App UI Elements --
let addNewNoteProjectBtn; // To be created dynamically
...
// -- [MODIFIED] Notes App State --
let notesCollectionRef, noteProjectsCollectionRef; // Firestore refs
let localNotesCache = [];
let localNoteProjectsCache = []; // NEW: Cache for note projects
let currentNoteId = null;
let unsubscribeFromNotes = null;
let unsubscribeFromNoteProjects = null; // NEW: Unsubscriber for note projects
let newlyCreatedNoteProjectId = null; // NEW: To focus new project for renaming
