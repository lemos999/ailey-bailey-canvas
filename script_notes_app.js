 ...
 */
export function ensureNotePanelHeader() {
 ...
 */
export function getNewNoteProjectDefaultName() {
    const baseName = "새 폴더";
    let i = 1;
 ...
 */
export function toggleNoteProjectExpansion(projectId) {
 ...
 */
export function startNoteProjectRename(projectId) {
 ...
 */
export function startNoteRename(noteId) {
 ...
 */
export async function handleAddNewNote() {
