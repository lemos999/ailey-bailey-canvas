...
Description: Contains all business logic and UI rendering for the enhanced Notes App, including panel management, drag & drop, and context menus.
*/
...
async function moveNoteToProject(noteId, projectId) {
    ...
    // If projectId is "null", it should be stored as null in Firestore.
