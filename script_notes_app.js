...
Version: 14.1 (WYSIWYG Default & Color Plugin)
Architect: [Username] & System Architect Ailey
Description: Integrates the powerful Toast UI Editor for a rich markdown editing experience. Default editor mode is now WYSIWYG and color syntax plugin has been added.
*/
...
function openNoteEditor(id) {
    ...
    // [MODIFIED] Initialize Toast UI Editor with WYSIWYG default and color plugin
    toastEditorInstance = new toastui.Editor({
        el: editorEl,
        initialValue: note.content || '',
        initialEditType: 'wysiwyg', // <-- [MODIFIED] Set default to WYSIWYG
        previewStyle: 'vertical',
        height: '100%',
        theme: document.body.classList.contains('dark-mode') ? 'dark' : 'light',
        plugins: [
            toastui.Editor.plugin.codeSyntaxHighlight,
            toastui.Editor.plugin.colorSyntax // <-- [ADDED] Activate color syntax plugin
        ],
        events: {
            change: debounce(() => {
