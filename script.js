...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initialize() {
        ...
        document.addEventListener('click', (e) => {
            ...
            if (!newItemMenu.contains(e.target) && !newItemBtn.contains(e.target)) {
        ...
        if (sessionListContainer) {
            sessionListContainer.addEventListener('click', (e) => {
                ...
                const projectItemHeader = e.target.closest('.project-header');
                ...
                else if (projectItemHeader) { toggleProjectExpansion(projectItemHeader.closest('.project-item').dataset.projectId); }
