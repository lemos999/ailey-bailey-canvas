...
Version: 11.1 (Modular JS Hotfix)
Architect: [Username] & System Architect Ailey
Description: Fixed a critical module dependency error. Moved prompt modal logic from apiManager.js to this entry point file to resolve the 'openPromptModal' export error and restore all UI functionality.
*/
...
function setupEventListeners() {
    ...
    // [FIXED] Custom Prompt Modal Event Listeners
    ...
    // [FIXED] Chat Mode Selector Listener to call local function
